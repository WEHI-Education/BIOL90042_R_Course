...
Using a dataset containing imaging-derived histology features, and tumour status (benign vs malignant), so far we have explored and transformed the data, and built an XGBoost model with pre-defined hyper-parameters.
